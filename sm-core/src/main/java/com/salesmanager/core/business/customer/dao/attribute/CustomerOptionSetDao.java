...
public interface CustomerOptionSetDao {
	...
	CustomerOptionSet getById(Long customerOptionId, Long customerOptionValueId);

	void update(CustomerOptionSet entity);

	void delete(CustomerOptionSet entity);
