            ...
            <script type="text/javascript"> 
				...
				function sendRequest(json,collection,object) {
					...
					$.ajax({
						  ...
						  url: "/mvc-showcase/index/profile_m/profile/",
						  cache: false,
						  type:"POST",
						  dataType:"json",
						  data:json,
...
<div class="container">
      ...
      <table>
            ...
            <tr>
                  ...
                  <td><span class="label">"user name" : </span></td><td><input name="id" type="text" class="textfield medium"><span class="label">,</span></td>

            </tr>

            <tr>

                  <td><span class="label">"age" : </span></td><td><input name="age" type="text" class="textfield short"><span class="label">,</span></td>

            </tr>

            <tr>

                  <td><span class="label">"sex" : </span></td><td><select name="sex" class="select short"><option value="m">M</option><option value="f">F</option><span class="label">,</span></td>

            </tr>

            <tr>

                  <td><span class="label">"looking for" : </span></td><td><select name="lookingfor" class="select short"><option value="m">M</option><option value="f" selected>F</option><span class="label">,</span></td>
