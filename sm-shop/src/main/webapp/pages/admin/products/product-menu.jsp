...
<%@ page session="false" %>
    ...
    <ul class="nav nav-pills">
    	...
    	<li class="enabled"><a href="<c:url value="/admin/products/setCategory.html" />?id=<c:out value="${productId}"/>"><s:message code="menu.product.category" text="Associate to categories" /></a></li>
