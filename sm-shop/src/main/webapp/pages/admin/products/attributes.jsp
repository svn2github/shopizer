...
<div class="tabbable">
				...
				<br/><br/>
				 ...
				 <c:set value="/admin/products/attributes/remove.htmlremove.html" var="removeUrl" scope="request"/>
				 <c:set value="/admin/products/attributes/editAttribute.html" var="editUrl" scope="request"/>
				 <c:set value="/admin/attributes/list.html" var="afterRemoveUrl" scope="request"/>
